    ...
    static {
        ...
        topic11Type2ProblemsBuilder.add(Problem.builder()
                        ...
                        .variables(Arrays.asList(
                                new Variable("start_hour", new Range(0, 23)),
                                new Variable("start_minute", new Range(0, 59)),
                                new Variable("duration_hour", new Range(0, 5)),
                                new Variable("duration_minute", new Range(0, 59))
                        ))
        ...
        topic11Type2ProblemsBuilder.add(Problem.builder()
                        ...
                        .variables(Arrays.asList(
                                new Variable("start_hour", new Range(0, 23)),
                                new Variable("start_minute", new Range(0, 59)),
                                new Variable("duration_hour", new Range(0, 8)),
                                new Variable("duration_minute", new Range(0, 59))
                        ))
        ...
        topic11Type2ProblemsBuilder.add(Problem.builder()
                        ...
                        .variables(Arrays.asList(
                                new Variable("start_hour", new Range(0, 23)),
                                new Variable("start_minute", new Range(0, 59)),
                                new Variable("duration_hour", new Range(0, 10)),
                                new Variable("duration_minute", new Range(0, 59))
                        ))
        ...
        topic11Type2ProblemsBuilder.add(Problem.builder()
                        ...
                        .variables(Arrays.asList(
                                new Variable("start_hour", new Range(0, 23)),
                                new Variable("start_minute", new Range(0, 59)),
                                new Variable("duration_hour", new Range(0, 12)),
                                new Variable("duration_minute", new Range(0, 59))
                        ))
