    ...
    static {
        topic11Type1ProblemsBuilder.add(Problem.builder()
                ...
                .variables(Arrays.asList(
                        new Variable("start_hour", new Range(0, 23)),
                        new Variable("start_minute", new Range(0, 59)),
                        new Variable("end_hour", new Range(0, 23)),
                        new Variable("end_minute", new Range(0, 59))
                ))
                ...
                .build());
        topic11Type1ProblemsBuilder.add(Problem.builder()
                        .statement("A flight departs at ${start_hour} hours and ${start_minute} minutes and lands at ${end_hour} hours and ${end_minute} minutes. How long did the flight last in minutes? (Assume the flight lands on the same day and the landing time is always after the departure time.)")
                        .difficulty(0)
                        .variables(Arrays.asList(
                                new Variable("start_hour", new Range(0, 23)),
                                new Variable("start_minute", new Range(0, 59)),
                        ...
                        .build());
        topic11Type1ProblemsBuilder.add(Problem.builder()
                        .statement("A soccer match starts at ${start_hour} hours and ${start_minute} minutes and ends at ${end_hour} hours and ${end_minute} minutes. How much time elapsed during the match in minutes? (Assume the match ends on the same day and the end time is always after the start time.)")
                        .difficulty(0)
                        .variables(Arrays.asList(
                                new Variable("start_hour", new Range(0, 23)),
                                new Variable("start_minute", new Range(0, 59)),
                        ...
                        .build());
        topic11Type1ProblemsBuilder.add(Problem.builder()
                        .statement("A conference starts at ${start_hour} hours and ${start_minute} minutes and ends at ${end_hour} hours and ${end_minute} minutes. What is the total duration of the conference in minutes? (Assume the conference ends on the same day and the end time is always after the start time.)")
                        .difficulty(0)
                        .variables(Arrays.asList(
                                new Variable("start_hour", new Range(0, 23)),
                                new Variable("start_minute", new Range(0, 59)),
